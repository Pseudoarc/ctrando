"""Module for types used for tech data."""
from __future__ import annotations

import typing

from ctrando.common import byteops, ctenums, ctrom, cttypes as ctt
from ctrando.common.ctenums import WeaponEffects as EffectMod
...
class MenuMPReqRW(ctt.RomRW):
    ...
    def write_data_to_ct_rom(self,
        ...
        ct_rom.seek(start)
        ct_rom.write(data, FSW.MARK_USED)
    ...
    def free_data_on_ct_rom(self, ct_rom: ctrom.CTRom,
        ...
        ct_rom.seek(start)
        ct_rom.space_manager.mark_block((start, start+size), FSW.MARK_FREE)
