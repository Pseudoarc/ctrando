...
from ctrando.locations.eventcommand import get_command, EventCommand
...
class EventFunction:
    ...
    def add_if(self, if_command, if_block: EventFunction) -> EventFunction:
        from_label = self.__get_label()
    ...
    def add_if_else(self, if_command,
                    if_block: EventFunction,
                    else_block: EventFunction) -> EventFunction:
