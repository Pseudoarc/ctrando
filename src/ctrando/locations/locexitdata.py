...
class LocOWExits(enum.Enum):
    ...
    NORTHERN_RUINS_600 = ScriptExitInfo(LocID.NORTHERN_RUINS_ENTRANCE_600, 0, FID.STARTUP, 0)
...
class PortalExits(enum.Enum):
    ...
    GUARDIA_FOREST = ScriptExitInfo(LocID.GUARDIA_FOREST_DEAD_END, 0x1, FID.STARTUP, 1)
...
_loc_exit_classes: tuple[set[LocOWExits], ...] = (
    ...
    # {LocOWExits.MAGUS_LAIR, LocOWExits.MAGUS_LAIR_END_SCENE_EPOCH},
    ...
    {LocOWExits.ZENAN_BRIDGE_600_SOUTH, LocOWExits.ZENAN_BRIDGE_600_SOUTH_BOSS},
    {LocOWExits.ZENAN_BRIDGE_600_NORTH, LocOWExits.ZENAN_BRIDGE_600_NORTH_BOSS},
